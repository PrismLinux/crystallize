...
mod imp {
  ...
  #[template(resource = "/org/crystalnetwork/crystallize/window.ui")]
...
impl CrystallizeWindow {
  ...
  fn show_about_dialog(&self) {
    let about = adw::AboutDialog::builder()
      ...
      .issue_url(
        "https://gitlab.com/crystalnetwork-studio/linux/prismlinux/os-build/crystallize/-/issues",
      )
